...
alert(`Los pasajes ida y vuelta tienen un costo de ${pasaje}`);
while(validar){

     let compraComida = Number(prompt(`que deseas comer escoje una opcion: \n
        1- almojabana con gaseosa $15.000 \n
        2- sobway con gaseosa $23.000 \n
        3- no comprar nada`));
...
alert(`la aerolina revisara tu maleta para verificar que cumpla los parametros`);
let factorReduccion = [];
...
alert(`El tamaño permitido es alto ${limiteAerolinea.alto} largo ${limiteAerolinea.largo} ancho ${limiteAerolinea.ancho}`);
...
alert(`El tamaño de tu maleta es alto ${tamañoMaleta.alto} largo ${tamañoMaleta.largo} ancho ${tamañoMaleta.ancho}`);
...
if (reducir){
    ...
    alert(`El tamaño reducido de maleta es alto ${tamañoDefinitivo.alto} largo ${tamañoDefinitivo.largo} ancho ${tamañoDefinitivo.ancho}`);
...
alert(`Debes traducir lo que le diras al taxista para que pueda en tenderte esto te costara $15.000`);
console.log(`Debes traducir lo que le diras al taxista para que pueda en tenderte esto te costara $15.000`);
presupuesto -= 15000;
...
alert(`Tu frase ${frase}`);
console.log(fraseTradus);
let traduccionFinal = fraseTradus.join("");
console.log(`Tu frase traducida es: ${traduccionFinal}`);
alert(`Tu frase traducida es: ${traduccionFinal}`);
...
while(validar){
    ...
    alert(`Taxista ${opciontaxi} vs tu ${opcionhildebrando}`)
...
while(true){
    ...
    if(actividad === 1){
        ...
        if(a == 1){
            ...
            console.log(`Excelente juego eres el mejor, has pasado un muy buen rato`);
            diasVacaciones +=1;
        }else if (a == 2){
...
console.log(`El viaje duro ${diasVacaciones} dias`)
console.log(`Tu presupuesto final es de $${presupuesto}`)
console.log(`Tus gastos fueron de $${gastos-presupuesto}`)
if ( muerto == 1){
